...
class RealTimeDataProcessor:
    ...
    def process_and_insert_stock_data(self, stock_df, required_columns, table_name='stock1'):
    ...
    def process_and_insert_report_data(self, report_df, required_columns, table_name='report1'):
        report_df.fillna(0, inplace=True)
        report_df.drop(['기준일자','종목코드','분기코드','주가코드'], axis=1, inplace=True)
        ...
        self.process_and_insert_data(report_df, column_name_mapping,  required_columns, table_name)   

    def process_and_insert_stock_prediction_data(self, stock_prediction_df, required_columns, table_name='stock_prediction1'):
        self.process_and_insert_data(stock_prediction_df, {'Change':'stock_change'}, required_columns, table_name)    
